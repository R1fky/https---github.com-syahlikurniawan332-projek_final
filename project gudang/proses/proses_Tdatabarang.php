    ...
    if ($statusupload == 0) {
        ...
        if (mysqli_num_rows($select) > 0) {
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "INSERT INTO tb_databarang (foto,namabarang,stokbarang,tanggalmasuk,letakbarang,kategori) values ('" . $kode_rand . $_FILES['foto']['name'] . "','$namabarang','$stokbarang','$tanggalmasuk','$letakbarang','$kategori')");
                if ($query) {
