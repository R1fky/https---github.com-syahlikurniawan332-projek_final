...
$select_kat_barang = mysqli_query($conn, "SELECT kategoribarang,id FROM tb_kategoribarang");
?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select" aria-label="Default select example" name="kategori" required>
                                            ...
                                            foreach ($select_kat_barang as $value) {
                                                echo "<option value=" . $value['id'] . ">$value[kategoribarang]</option>";
                                            }
                                            ?>
                                        </select>
                ...
                ?>
                    <!-- Edit Data Barang -->
                    <div class="modal fade" id="modaleditbarang<?php echo $row['id_databarang'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_edit_barang.php" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" value="<?php echo $row['id_databarang'] ?>" name="id">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-floating mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="kategori">
                                                ...
                                                foreach ($select_kat_barang as $value) {
                                                    if ($row['kategori'] == $value['id']) {
                                                        echo "<option selected value=" . $value['id'] . ">$value[kategoribarang]</option>";
                                                    } else {
                                                        echo "<option value=" . $value['id'] . ">$value[kategoribarang]</option>";
                                                    }
                                                }
                    ...
                    <!-- Delete Data Barang -->
                    <div class="modal fade" id="modaldeletebarang<?php echo $row['id_databarang'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_delete_barang.php" method="POST">
                                        <input type="hidden" value="<?php echo $row['id_databarang'] ?>" name="id_databarang">                                        
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#modaleditbarang<?php echo $row['id_databarang'] ?>"><i class="bi bi-pencil-square"></i></button>
                                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modaldeletebarang<?php echo $row['id_databarang'] ?>"><i class="bi bi-trash3-fill"></i></button>
                                            </div>
                                        </td>
                    </div>
                    </tr>
